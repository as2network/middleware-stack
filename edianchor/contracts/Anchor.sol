...
contract AnchoringContract is Ownable, ERC721BasicTokenContract {
    ...
    */
    function _save(
        ...
        DocumentReference memory reference = DocumentReference(
            documentId,
            versionId,
            now
        );
    ...
    */
    function _hashExists(string hash) internal returns (bool) {
        bytes32 referenceId = keccak256(abi.encodePacked(hash));
            ...
            DocumentReference storage targetDocumentReference
    ...
    */
        ...
        returns (Version)
    {
        require(_isReferenceExists(referenceId));
            ...
            DocumentReference storage targetDocumentReference
         = documentReference[referenceId];
        Version[] storage versions = versionOf[targetDocumentReference
            .documentId];
        Version storage targetVersion = versions[targetDocumentReference
            .versionId];
    ...
    */
    function createDocument(string hash, string description)
        external
        onlyOwner
        returns (bytes32)
    {
